  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-slate-50 text-slate-900 relative overflow-hidden">
      ...
      <div className="z-10 max-w-5xl w-full space-y-12 text-center">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 w-full mx-auto">
          ...
          >
            ...
            <h3 className="text-xl font-semibold mb-2 text-slate-900">
              Interview Based On Job Description
            </h3>
          ...
          >
            ...
            <p className="text-sm text-slate-500 text-center">
              ...
              practice based on your profile.
            </p>
          </button>
          ...
          >
            ...
            <p className="text-sm text-slate-500 text-center">
              Mention a role (e.g. "Full Stack") and the AI will customize the
              session for you.
            </p>
          </button>
        ...
        {/* Proctored Interview Full Banner */}
